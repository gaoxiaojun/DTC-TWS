...
class CodeMsgPair {
public:
    CodeMsgPair(int code, QString msg) : m_errorCode(code), m_errorMsg(msg) {
	}
private:
	int m_errorCode;
    QString m_errorMsg;
public:
    ...
    const QString& msg() const			{ return m_errorMsg;  }
};
...
static const CodeMsgPair SOCKET_ERROR(10001, "Socket Error -");

//Q_DECLARE_METATYPE(CodeMsgPair)
